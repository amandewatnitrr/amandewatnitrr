...
def render_svg(ascii_lines, stats_lines, theme):
    ...
    # readable at, so it gets its own (smaller) font metrics -- sharing one
    # size with the stats column would force a choice between a tiny,
    # cramped stats block or a blown-up, low-detail portrait.
    ascii_font_size = 7
    ascii_line_height = 8.6
    ascii_char_width = 4.3
    pad = 24
